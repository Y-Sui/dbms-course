...
import dbms.suiyuan.DbGenerator;
...
*/
	   DbGenerator db = new DbGenerator("iDB2", 512);//创建数据库对象及空日志文件
	   System.out.println("数据库创建成功！");
//	   System.out.println("当前testDB文件夹下的内容(只有日志文件)：");
//	   showDir("TestDB");//建立了日志文件
	   
	   File fl = db.gFile();//得到文件对象
	   String datafileName ="iDB_datafile.dbf";
	   BlockID blk = new BlockID(datafileName, 0);//创建块对象
